...
cloudinary.config({ 
    cloud_name: process.env.CLOUDINARY_CLOUD_NAME ?? "surajgsn",
    api_key: process.env.CLOUDINARY_API_KEY ?? "852652549314759",
    api_secret: process.env.CLOUDINARY_API_SECRET  ?? "QJz1gDQk0Fts_Qu3E3W6sK2Imrk"
});
